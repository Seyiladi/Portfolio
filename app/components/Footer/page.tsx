    ...
    <div className="">
      <footer className="bg-[#17191F] text-gray-300 py-8 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-xl md:text-[32px] font-semibold text-white font-satoshi">
            Get in touch
          </h2>
          <p className="mt-[16px] mb-[32px] text-[#FFFFFF80] max-w-[800px] mx-auto text-[20px] leading-8 font-satoshi ">
